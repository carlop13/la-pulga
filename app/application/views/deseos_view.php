...
<head>
    ...
    <title>Lista de Deseos - Almacén La Pulga</title>
...
.badge-counter {
    ...
    min-width: 18px;
    min-height: 18px;
    display: none; /* Agrega esta línea */
}
        ...
        @media (max-width: 768px) {
            ...
            /* Acomodo de los iconos circulares en móvil */
            .action-buttons {
                display: flex !important;
                width: 100% !important;
                justify-content: center !important;
    ...
    <nav class="catalog-navbar">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="search-box">
                <input type="text" name="caja_busqueda" id="caja_busqueda" placeholder="Buscar productos en tu lista..."/>
            </div>
            ...
            <div class="action-buttons">
                ...
                <a href="<?= base_url() ?>frontend/deseos/<?= $this->session->id_usu ?>/<?= $this->session->token ?>" class="btn-action-icon" style="background: white; color: var(--primary-color);" title="Lista de deseos">
