...
<head>
    ...
    <title>Catálogo de Muebles - Almacén La Pulga</title>
    ...
    <style>
        ...
        .modal-header {
            background-color: var(--primary-color) !important; /* Color Rojo de La Pulga */
            border-bottom: none;
            padding: 15px 25px;
        }
...
@media (max-width: 768px) {
            ...
            /* 👇 AGREGA ESTE BLOQUE PARA RELLENAR EL HUECO BLANCO 👇 */
            .promo-bar {
                height: 56px !important; /* Estira la barra para tocar a la otra */
...
<body>
    ...
    <nav class="catalog-navbar">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="search-box">
                <input type="text" name="caja_busqueda" id="caja_busqueda" placeholder="Buscar productos, marcas y más..."/>
            </div>
    ...
    <div class="container mt-4 mb-5">
        ...
        <h2 class="page-title">Catálogo de Muebles</h2>
