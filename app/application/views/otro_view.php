...
<head>
    ...
    <title>Catálogo de Otros Productos - Almacén La Pulga</title>
...
<body>
    ...
    <div class="container mt-4 mb-5">
        ...
        <h2 class="page-title">Catálogo de Otros Productos</h2>
    ...
    <script src="<?=base_url()?>static/js/otro.js" ></script>
