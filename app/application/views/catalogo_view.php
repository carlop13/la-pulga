...
<head>
    ...
    <title>Catálogo de Productos - Almacén La Pulga</title>
...
.badge-counter {
    ...
    display: none; /* Agrega esta línea */
        ...
        .btn-logout {
            background-color: #212529; /* Oscuro para contraste */
            color: white;
            border-radius: 25px;
            padding: 8px 16px;
            font-weight: 600;
        ...
        @media (max-width: 768px) {
            ...
            /* Ocultar la palabra "Cerrar sesión" en celulares para ahorrar espacio */
    ...
    <nav class="catalog-navbar">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="search-box">
                <input type="text" name="caja_busqueda" id="caja_busqueda" placeholder="Buscar productos en el catálogo..."/>
            </div>
