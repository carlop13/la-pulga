...
<head>
    ...
    <title>Catálogo de Decoración - Almacén La Pulga</title>
...
<body>
    ...
    <nav class="catalog-navbar">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="search-box">
                <input type="text" name="caja_busqueda" id="caja_busqueda" placeholder="Buscar decoración, marcas y más..."/>
            </div>
    ...
    <div class="container mt-4 mb-5">
        ...
        <h2 class="page-title">Catálogo de Decoraciones</h2>
    ...
    <script src="<?=base_url()?>static/js/descoracion.js" ></script>
